...
-Vì ban đầu chúng ta chưa có file config webpack nên nó không hiểu mode và entry là gì, chúng ta cần sửa lại như vậy : build": "webpack --mode=development --entry=./src/index.js". Khi mà các bạn đã tạo được file webpack.config.js rồi thì sửa câu lệnh trên thành
...
- Webpack mặc định chỉ hiểu JavaScript. Để xử lý CSS, hình ảnh, TypeScript... cần Loaders.
...
- Plugins giúp mở rộng tính năng, tối ưu hóa file đầu ra.
